    ...
    <ScreenWrapper bg='#E3E2EB'>
      ...
      <View style={styles.container as StyleProp<ViewStyle>}>
        ...
        <View style={styles.footer as StyleProp<ViewStyle>}>
          <Text style={styles.footerText as StyleProp<TextStyle>}>Não possui uma conta?  </Text>
          <Pressable onPress={() => router.push("./signUp")}>
            <Text style={[styles.footerText, {color: theme.colors.primary, fontWeight: theme.fonts.semibold}] as StyleProp<TextStyle>}>Cadastre-se</Text>
          </Pressable>
        </View>
      </View>
    </ScreenWrapper>
